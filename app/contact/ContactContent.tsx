...
import { Mail, MessageSquare, Twitter, Github, LifeBuoy } from "lucide-react";
      ...
      <div className="max-w-4xl mx-auto px-6 py-20">
        ...
        >
          ...
          <p className="text-secondary/60 text-lg mb-16 max-w-2xl">
            Have questions about ZBR? Whether you need help with your code or
        ...
        >
          ...
          >
            ...
            <p className="text-secondary/40 text-sm">
              Join our community to get help from other developers.
            </p>
            <span className="text-primary text-sm mt-4 block font-medium">
              Join Discord
            </span>
          ...
          <a
            href="https://github.com/zbrlang/zbr/issues"
            target="_blank"
