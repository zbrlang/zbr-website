    ...
    <motion.div
      ...
      className={`group bg-white/[0.02] border rounded-2xl transition-all duration-300 max-w-full overflow-hidden ${
        isExpanded
          ...
          : "border-white/5 hover:border-primary/30 hover:bg-white/[0.04]"
      }`}
    >
              ...
              {hasParam && (
                <div className="flex flex-col gap-2">
                  ...
                  <input
                    ...
                    placeholder={
                      endpoint.path.includes("functions")
                        ? "e.g. Zabs"
                        : "e.g. onMessage"
                    }
                ...
                <div className="space-y-2 min-w-0 max-w-full">
                  <div className="flex items-center justify-between">
                    ...
                    <button
                      ...
                      className="text-secondary/20 hover:text-white transition-colors"
                    >
                      <X size={14} />
                    </button>
                  </div>
      ...
      <main className="max-w-5xl mx-auto px-6 pt-32 pb-24 relative z-10 w-full">
        ...
        >
          ...
          <p className="text-secondary/60 text-lg md:text-xl max-w-2xl leading-relaxed">
            Public access to ZBR function and trigger definitions used across
            the documentation, CLI, and developer tooling.
          </p>
