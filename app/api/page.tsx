...
import { Database, Code2, Zap, ArrowRight } from 'lucide-react';
...
export default function ApiLanding() {
  return (
    <div className="min-h-screen bg-background text-foreground font-['Hubot-Sans'] selection:bg-primary/30">
      ...
      <main className="max-w-5xl mx-auto px-6 pt-32 pb-24 relative z-10">
        ...
        >
          <div className="flex items-center gap-3 text-primary">
            <Database size={24} />
            <span className="text-[10px] font-bold uppercase tracking-[0.3em]">ZBR Meta API</span>
          </div>
        ...
        >
          <div className="flex items-center gap-4 text-secondary/40 text-sm">
            <Zap size={16} className="text-primary" />
            <span>High-performance metadata delivery</span>
          </div>
          <Link 
            href="/docs" 
