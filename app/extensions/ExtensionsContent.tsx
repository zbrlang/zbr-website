      ...
      <div className="max-w-5xl mx-auto px-6 py-20">
        ...
        >
          ...
          <p className="text-secondary/60 text-lg mb-16 max-w-2xl">
            Write ZBR commands with full editor support. Syntax highlighting,
            snippets, and completions everywhere you code, from your editor to
            the terminal to the web.
          </p>
        </motion.div>
            ...
            >
              <div className="flex items-start justify-between mb-6">
                <div>
                  ...
                  <span
                    className={`inline-block text-xs font-semibold px-3 py-1 rounded-full border ${ext.statusColor}`}
                  >
                    {ext.status}
                  </span>
                </div>
              ...
              <div className="mb-8">
                <p className="text-xs font-bold uppercase tracking-[0.2em] text-secondary/40 mb-3">
                  Features
                </p>
        ...
        >
          ...
          <p className="text-secondary/60 text-sm mb-6">
            Get started with ZBR extensions in minutes. Choose your editor and
            install the extension to begin writing ZBR code with full editor
            support.
          </p>
          <a
