      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="flex flex-col md:flex-row justify-between items-start gap-16 mb-24">
          <div className="max-w-sm space-y-6">
            <div className="text-3xl font-bold tracking-tighter text-foreground font-['Hubot-Sans']">
              ZBR
            </div>
            <p className="text-secondary/60 leading-relaxed text-sm">
              ZBR is a scripting language for Discord bots powered by a
              high-performance Rust runtime engine.
            </p>
            <div className="flex gap-4">
              <Link
                ...
                className="w-10 h-10 rounded-full bg-white/[0.03] border border-white/[0.08] flex items-center justify-center text-secondary/40 hover:text-primary hover:border-primary/50 transition-all"
              >
                <Github size={18} />
              </Link>
              <Link
          ...
          <div className="flex flex-wrap gap-12 md:gap-24">
            ...
            <div className="space-y-6">
              ...
              <ul className="space-y-3">
                ...
                <li>
                  <Link
                    href="https://github.com/zbrlang/zbr/releases"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-secondary/40 hover:text-primary transition-colors text-xs font-medium"
                  >
                ...
                <li>
                  <Link
                    href="https://www.npmjs.com/package/@zbrlang/zbr"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-secondary/40 hover:text-primary transition-colors text-xs font-medium"
                  >
        ...
        <div className="pt-8 border-t border-white/[0.03] flex flex-col md:flex-row justify-between items-center gap-6 text-[10px] font-bold uppercase tracking-[0.2em] text-secondary/20">
          ...
          <div className="flex items-center gap-2">
            <span>BUILT BY</span>
            <a href="https://zubariel.is-a.dev">
