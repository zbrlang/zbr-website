        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-32 items-center">
          ...
          >
            ...
            <p className="text-xl text-secondary/40 leading-relaxed">
              ...
              that parses and executes bot logic. Built on{" "}
              <a
              ...
              , it handles the Discord gateway with native speed.
            </p>
            ...
            <div className="glass-panel aspect-square rounded-3xl flex flex-col items-center justify-center relative overflow-hidden p-12 bg-black/40">
              ...
              <div className="relative w-full h-full flex items-center justify-center">
                ...
                <div className="relative z-10 w-32 h-32 bg-primary/5 border border-primary/20 rounded-2xl flex items-center justify-center backdrop-blur-xl">
                  ...
                  <Cpu
                    size={48}
                    className="text-primary/60 relative z-20"
                    strokeWidth={1}
                  />
              ...
              <div className="absolute top-8 right-8 text-right space-y-1">
                <div className="text-[8px] text-primary/40 uppercase tracking-widest font-bold">
                  Shard #0
                </div>
              ...
              <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center">
                <div className="text-[10px] font-bold text-primary/40 uppercase tracking-widest mb-2">
                  Engine Core Active
                </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          ...
          >
            <div>
              ...
              <p className="text-xl text-secondary/40 leading-relaxed">
                ZBR uses a functional, tag-based syntax that feels familiar but
                removes all the boilerplate of traditional Discord libraries.
              </p>
            </div>
            ...
            <div className="space-y-4">
              {[
                {
                  type: "Functional Syntax",
                  desc: "Concise function-based logic like Ztitle{args}.",
                },
                {
                  type: "SQLite Persistence",
                  desc: "Native state management with ZsetVar and ZgetVar.",
                },
                {
                  type: "In-Process Engine",
                  desc: "Code executes directly in the gateway process, no separate server needed.",
                },
              ].map((item, i) => (
                <div
                  key={i}
                  className="flex gap-4 items-center p-4 rounded-2xl bg-white/[0.02] border border-white/[0.05]"
                >
      ...
      <section className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
          {features.map((feature, index) => (
            ...
            >
              <span className="text-sm font-semibold text-secondary/40 group-hover:text-primary transition-colors tracking-wide uppercase">
                {feature}
              </span>
            </motion.div>
          ))}
