        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          ...
          >
            ...
            <p className="text-lg text-secondary/60 mb-8 max-w-lg">
              ZBR is a scripting language designed for Discord bots. Write your
              commands in `.zbr` files and watch them come to life without
              ...
              <div className="flex gap-3 items-start">
                ...
                <div>
                  ...
                  <p className="text-xs text-secondary/40">
                    Save a file and the changes are live instantly.
                  </p>
                </div>
              </div>
              <div className="flex gap-3 items-start">
                ...
                <div>
                  ...
                  <p className="text-xs text-secondary/40">
                    Built-in support for embeds, components, and events.
                  </p>
                </div>
              </div>
            </div>
      ...
      <section className="max-w-7xl mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          ...
          >
            ...
            <p className="text-lg text-secondary/60 mb-8 max-w-lg">
              Manage user, server, and global variables effortlessly. ZBR
              handles the database for you, ensuring your bot&apos;s data is
              safe and accessible.
            </p>
