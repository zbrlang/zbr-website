...
const terminalSteps = [
  {
    ...
    output: ["added 1 package in 0.8s", "zbr version", "zbr v1.8.3"],
              ...
              <button
                ...
                className={`inline-flex items-center justify-center gap-2 px-6 py-3 rounded-full text-sm font-semibold transition-colors ${
                  mode === "webapp"
                    ...
                    : "bg-white/[0.03] text-white border border-white/[0.08] hover:bg-white/[0.08]"
                }`}
              >
                ...
                >
                  <div className="flex gap-4 items-start">
                    ...
                    <div>
                      ...
                      <p
                        className={`text-sm mt-2 leading-relaxed transition-opacity ${
                          activeStep === index
                            ? "opacity-100"
                ...
                <div className="p-12 font-mono text-sm min-h-[300px] bg-black/40 relative flex items-center justify-center text-center">
                  <div className="space-y-6">
                    <h3 className="text-2xl font-bold text-white">
                      Visual Webapp Editor
                    </h3>
                    <p className="text-secondary/60 max-w-sm">
                      Build commands and manage variables visually in the
                      browser. Use the <b>Run</b> button for rapid cloud
                      testing, or export as ZIP to host yourself for 24/7
                      production.
                    </p>
                    <a
