...
1. **Access the Webapp:** Visit [https://app.zbrlang.tech](https://app.zbrlang.tech).
2. **Create or Import:**
...
2. **Install CLI:** [Follow the installation guide](/docs/guides/installation) to install the ZBR CLI on your server.
